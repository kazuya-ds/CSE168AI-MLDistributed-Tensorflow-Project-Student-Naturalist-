...
This is a project by Amy Chan continued from the group project for UC Merced's CSE168 Distributed Systems class taught by Professor Xiaoyi Lu lab part two using a custom dataset and custom tensorflow model.
